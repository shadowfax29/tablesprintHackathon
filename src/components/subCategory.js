  ...
  const columns = React.useMemo(
    () => [
      ...
      { 
        Header: 'Image', 
        accessor: 'image',
        Cell: ({ value }) => <img src={value} alt="subcategory" className="h-10 w-10 rounded-full" />
      },
      ...
      { 
        ...
        Cell: ({ value,row }) => (
          <div className="flex space-x-2">
            ...
            <button onClick={() => openModal(value)} className="text-red-600 hover:text-red-900">
              Delete
            </button>
          </div>
        )
  ...
  return (
    <div className='relative min-h-screen'>
      ...
      <div className="grid grid-cols-2 gap-4">
        <Sidebar />
        <div className="p-4 flex flex-col mt-20 w-10/12 fixed top-0 right-0 z-10 h-screen bg-white shadow-lg rounded-lg">
          <div className="p-6 w-full">
            <div className="flex justify-between items-center mb-4">
              <h1 className="text-2xl font-bold">Subcategory</h1>
              <button onClick={() => { navigate("/addSubCategory") }} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                Add Subcategory
              </button>
            </div>
        ...
        <div id="deleteModal" tabIndex="-1" aria-hidden="true" className="fixed inset-0 z-50 flex justify-center items-center w-full h-full bg-gray-900 bg-opacity-50">
          <div className="relative p-4 w-full max-w-md h-auto">
            <div className="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
              ...
              <p className="mb-4 text-gray-500 dark:text-gray-300">Are you sure you want to delete this subcategory?</p>
              <div className="flex justify-center items-center space-x-4">
                ...
                <button 
                  onClick={() => {
                    handleDelete(subcategoryIdToDelete);
                  }} 
